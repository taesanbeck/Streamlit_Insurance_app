...
Currently, GoForward uses a universal pricing system at $150/month. However, we believe this does not accurately capture distinctions across age and overall health levels. We propose a pricing model that is enhanced such that those nuances are accommodated. 
